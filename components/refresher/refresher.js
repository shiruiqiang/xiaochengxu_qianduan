...
i.prototype.on = function(t, e, i) {
    ...
    for (t = t ? t.split(o) : a(n); s = t.shift();) if (r = n[s]) if (e || i) for (f = r.length - 2; f >= 0; f -= 2) e && r[f] !== e || i && r[f + 1] !== i || r.splice(f, 2);
    else delete n[s];
    return this
    ...
    for (; i = t.shift();)(s = e.all) && (s = s.slice()), (r = e[i]) && (r = r.slice()), "all" !== i && (c = n(r, h, this) && c), c = n(s, [i].concat(h), this) && c;
    return c
...
a || (a = function(t) {
    ...
    var e = i.prototype;
    if (s(t)) for (var n in e) e.hasOwnProperty(n) && (t.prototype[n] = e[n]);
    else {
        var r = new i;
...
var f = function() {
    ...
    return r(n, [{
        key: "__init",
        value: function() {
            this.lastTime = 0, this.activated = !1, this.events = new i, this.mergeOptions(this.options), this.scope.setData(t({}, "$wux.refresher", this.options))
        }
    }, {
        key: "setDefaults",
        value: function() {
        ...
        value: function(t) {
            ...
            for (var i in e) e.hasOwnProperty(i) && (this.options[i] = void 0 !== t[i] ? t[i] : e[i], "function" == typeof this.options[i] && (this.options[i] = this.options[i].bind(this)))
        }
    }, {
        ...
        value: function() {
            var e = this,
                i = "transition: transform .4s; transform: translate3d(0px, 0px, 0px) scale(1);",
                n = function(i, n) {
            ...
            return {
                ...
                refreshing: function() {
                    n("style", "transition: transform .4s; transform: translate3d(0, 50px, 0) scale(1);"), n("className", "active refreshing")
                },
                tail: function() {
                    n("className", "active refreshing refreshing-tail")
                },
                move: function(t) {
                    n("style", "transition-duration: 0s; transform: translate3d(0, " + t + "px, 0) scale(1);"), n("className", t < e.options.distance ? "visible" : "active")
                }
            }
        }
    }, {
        ...
        value: function(t) {
            ...
            var e = this.getRefresherMethods(),
                i = this.getTouchPosition(t);
            this.start = i, this.diffX = this.diffY = 0, e.activate()
        }
    }, {
        key: "touchmove",
        value: function(t) {
            ...
            this.diffY = Math.pow(this.diffY, .8), !this.activated && this.diffY > this.options.distance ? (this.activated = !0, "function" == typeof this.options.onPulling && this.options.onPulling()) : this.activated && this.diffY < this.options.distance && (this.activated = !1), e.move(this.diffY)
        }
    }, {
        key: "touchend",
        value: function(t) {
            ...
            e.deactivate(), Math.abs(this.diffY) >= this.options.distance && (this.events.once("scroll.refreshComplete", this.finishPullToRefresh.bind(this)), e.refreshing(), "function" == typeof this.options.onRefresh && this.options.onRefresh())
        }
    }]), n
}();
exports.
