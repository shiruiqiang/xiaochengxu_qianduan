...
var e = function() {
    ...
    n = function() {
        ...
        return e(n, [{
            key: "__init",
            value: function() {
                this.page = getCurrentPages()[getCurrentPages().length - 1], this.setData = this.page.setData.bind(this.page), this.__initState()
            }
        }, {
            key: "__initState",
            value: function() {
            ...
            value: function() {
                ...
                if (!this.isEmptyObject(e)) for (var n in e) e.hasOwnProperty(n) && "function" == typeof e[n] && (this[n] = e[n] = e[n].bind(this), this.page[i + "." + n] = e[n], this.setData(t({}, i + "." + n, i + "." + n)))
            }
        }, {
            ...
            value: function() {
                ...
                this.setData((i = {}, t(i, this.options.scope + ".animateCss", e), t(i, this.options.scope + ".visible", !0), i))
            }
        }, {
            key: "setHidden",
            value: function() {
