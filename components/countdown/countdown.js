...
var e = function() {
    ...
    n = function() {
        ...
        return e(n, [{
            key: "__init",
            value: function() {
                this.page = getCurrentPages()[getCurrentPages().length - 1], this.setData = this.page.setData.bind(this.page), this.restart(this.options)
            }
        }, {
            key: "setDefaults",
            value: function() {
            ...
            value: function(t) {
                ...
                for (var n in e) e.hasOwnProperty(n) && (this.options[n] = void 0 !== t[n] ? t[n] : e[n], "date" === n && "object" != typeof this.options.date && (this.options.date = new Date(this.options.date)), "function" == typeof this.options[n] && (this.options[n] = this.options[n].bind(this)));
                "object" != typeof this.options.date && (this.options.date = new Date(this.options.date))
            }
        }, {
            key: "getDiffDate",
            value: function() {
                var t = (this.options.date - Date.now() + this.options.offset) / 1e3,
                    e = {
                        years: 0,
                        days: 0,
                        hours: 0,
            ...
            key: "update",
            value: function(t) {
                return this.options.date = "object" != typeof t ? new Date(t) : t, this.render(), this
            }
        }, {
            key: "stop",
            value: function() {
