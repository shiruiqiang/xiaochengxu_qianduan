...
! function(t) {
    if ("object" == ("undefined" == typeof exports ? "undefined" : e(exports)) && "undefined" != typeof module) module.exports = t();
    else if ("function" == typeof define && define.amd) define([], t);
    else {
        var n;
        "undefined" != typeof window ? n = window : "undefined" != typeof global ? n = global : "undefined" != typeof self && (n = self), n.Promise = t()
    }
}(function() {
    var t, n, r;
    return function t(e, n, r) {
            ...
            e.exports = function(t, e, n, r) {
                ...
                t.prototype.bind = function(o) {
                    ...
                    if (u._setBoundTo(l), l instanceof t) {
                        ...
                        f._then(e, a, void 0, u, p), l._then(s, c, void 0, u, p), u._setOnCancel(l)
                    ...
                    return function(c) {
                        ...
                        t: for (var u = 0; u < t.length; ++u) {
                            ...
                            if (f === Error || null != f && f.prototype instanceof Error) {
                                ...
                                var p = i(f).call(l, c);
                                if (p === o) return p;
                                if (p) return i(a).call(l, c)
                            } else if (n.isObject(c)) {
                                for (var h = r(f), _ = 0; _ < h.length; ++_) {
                                    var d = h[_];
            ...
            n.exports = function(n, r) {
                ...
                function w(t, n, r) {
                    if ("undefined" != typeof console) {
                        ...
                        "function" == typeof R ? R(i, r) : "function" != typeof console.log && "object" !== e(console.log) || console.log(i)
                    }
                }
                function k(t, e, n, r) {
                    var i = !1;
                ...
                function S(t) {
                    ...
                    et(this, S), e > 32 && this.uncycle()
                }
                var O, P, R, x = n._getDomain,
                    A = n._async,
                    L = t("./errors").Warning,
                    N = t("./util"),
                    I = N.canAttachTrace,
                    ...
                    M = !(0 == N.env("BLUEBIRD_LONG_STACK_TRACES") || !q && !N.env("BLUEBIRD_LONG_STACK_TRACES")),
                ...
                n.longStackTraces = function() {
                    ...
                    if (!nt.longStackTraces && F()) {
                        ...
                        nt.longStackTraces = !0, $ = function() {
                            if (A.haveItemsQueued() && !nt.longStackTraces) throw new Error("cannot enable long stack traces after promises have been created\n\n    See http://goo.gl/MqrFmX\n");
                            n.prototype._captureStackTrace = t, n.prototype._attachExtraTrace = e, r.deactivateLongStackTraces(), A.enableTrampoline(), nt.longStackTraces = !1
                        }, n.prototype._captureStackTrace = h, n.prototype._attachExtraTrace = _, r.activateLongStackTraces(), A.disableTrampolineIfNecessary()
                    }
                ...
                var z = function() {
                    try {
                        ...
                        return (t = document.createEvent("CustomEvent")).initCustomEvent("testingtheevent", !1, !0, {}), N.global.dispatchEvent(t),
                        function(t, e) {
                ...
                n.config = function(t) {
                    if ("longStackTraces" in (t = Object(t)) && (t.longStackTraces ? n.longStackTraces() : !t.longStackTraces && n.hasLongStackTraces() && $()), "warnings" in t) {
                        var e = t.warnings;
                    ...
                    if ("cancellation" in t && t.cancellation && !nt.cancellation) {
                        ...
                        n.prototype._clearCancellationData = u, n.prototype._propagateFrom = f, n.prototype._onCancel = c, n.prototype._setOnCancel = l, n.prototype._attachCancellationCallback = s, n.prototype._execute = a, Y = f, nt.cancellation = !0
                    }
                    "monitoring" in t && (t.monitoring && !nt.monitoring ? (nt.monitoring = !0, n.prototype._fireEvent = J) : !t.monitoring && nt.monitoring && (nt.monitoring = !1, n.prototype._fireEvent = o))
                ...
                N.inherits(S, Error), r.CapturedTrace = S, S.prototype.uncycle = function() {
                    var t = this._length;
                    if (!(t < 2)) {
                ...
                var et = function() {
                    ...
                    var i = new Error;
                    if ("string" == typeof i.stack && i.stack.split("\n")[0].indexOf("stackDetection@") >= 0) return D = /@/, V = n, Q = !0,
                    function(t) {
                    ...
                    return "stack" in i || !o || "number" != typeof Error.stackTraceLimit ? (V = function(t, n) {
                        return "string" == typeof t ? t : "object" !== (void 0 === n ? "undefined" : e(n)) && "function" != typeof n || void 0 === n.name || void 0 === n.message ? E(n) : n.toString()
                    }, null) : (D = t, V = n, function(t) {
                    ...
                    checkForgottenReturns: function(t, e, n, r, i) {
                        if (void 0 === t && null !== e && W) {
                            ...
                            if (e._trace) {
                                ...
                                if (c.length > 0) for (var p = c[0], l = 0; l < s.length; ++l) if (s[l] === p) {
                                    l > 0 && (a = "\n" + s[l - 1]);
                                    break
                                }
                            }
        ...
        15: [function(t, e, n) {
            e.exports = function() {
                ...
                var b = function() {}, C = {}, w = {}, k = t("./thenables")(i, b),
                    E = t("./promise_array")(i, b, k, f, n),
                    j = t("./context")(i),
                ...
                return i.prototype.toString = function() {
                    ...
                    if (e > 1) {
                        ...
                        for (n = 0; n < e - 1; ++n) {
                            var o = arguments[n];
                            if (!h.isObject(o)) return f("expecting an object but got A catch statement predicate " + h.classString(o));
                            r[i++] = o
                        }
                    ...
                    return "function" != typeof t ? f("expecting a function but got " + h.classString(t)) : this.all()._then(t, void 0, void 0, C, void 0)
                    ...
                    var f = c();
                    if (0 != (50397184 & u)) {
                        var p, _, d = l._settlePromiseCtx;
                        0 != (33554432 & u) ? (_ = l._rejectionHandler0, p = t) : 0 != (16777216 & u) ? (_ = l._fulfillmentHandler0, p = e, l._unsetRejectionIsUnhandled()) : (d = l._settlePromiseLateCancellationObserver, _ = new m("late cancellation observer"), l._attachExtraTrace(_), p = e), v.invoke(d, l, {
                            handler: null === f ? p : "function" == typeof p && h.domainBind(f, p),
                            promise: s,
                            receiver: r,
                            value: _
                        })
                    } else l._addCallbacks(t, e, s, r, f);
                    return s
                    ...
                    if (0 == (65536 & i)) {
                        r._pushContext();
                        var o;
                        e === C ? n && "number" == typeof n.length ? o = R(t).apply(this._boundValue(), n) : (o = P).e = new g("cannot .spread() a non-array: " + h.classString(n)) : o = R(t).call(e, n);
                        var a = r._popContext();
                        0 == (65536 & (i = r._bitField)) && (o === w ? r._reject(n) : o === P ? r._rejectCallback(o.e, !1) : (F.checkForgottenReturns(o, a, "", r, this), r._resolveCallback(o)))
                    }
                    ...
                    var a = t instanceof i,
                        s = this._bitField,
                        c = 0 != (134217728 & s);
                    0 != (65536 & s) ? (a && t._invokeInternalOnCancel(), r instanceof T && r.isFinallyHandler() ? (r.cancelPromise = t, R(e).call(r, o) === P && t._reject(P.e)) : e === u ? t._fulfill(u.call(r)) : r instanceof n ? r._promiseCancelled(t) : a || t instanceof E ? t._cancel() : r.cancel()) : "function" == typeof e ? a ? (c && t._setAsyncGuaranteed(), this._settlePromiseFromHandler(e, r, o, t)) : e.call(r, o, t) : r instanceof n ? r._isResolved() || (0 != (33554432 & s) ? r._promiseFulfilled(o, t) : r._promiseRejected(o, t)) : a && (c && t._setAsyncGuaranteed(), 0 != (33554432 & s) ? t._fulfill(o) : t._reject(o))
                ...
                }, h.notEnumerableProp(i, "_makeSelfResolutionError", l), t("./method")(i, b, k, f, F), t("./bind")(i, b, k, F), t("./cancel")(i, E, f, F), t("./direct_resolve")(i), t("./synchronous_inspection")(i), t("./join")(i, E, k, b, v, c), i.Promise = i, i.version = "3.4.6", h.toFastProperties(i), h.toFastProperties(i.prototype), s({
                    a: 1
                }), s({
                    b: 2
                }), s({
        ...
        16: [function(t, e, n) {
            e.exports = function(e, n, r, i, o) {
                ...
                return c.inherits(s, o), s.prototype.length = function() {
                    ...
                    if (null !== (s = c.asArray(s))) 0 !== s.length ? this._iterate(s) : -5 === o ? this._resolveEmptyArray() : this._resolve(a(o));
                    else {
        ...
        20: [function(t, e, n) {
            e.exports = function(e, n) {
                ...
                function a(t, r, i) {
                    ...
                    var l = !0,
                        u = s.tryCatch(r).call(t, function(t) {
                ...
                return function(t, r) {
                    if (l(t)) {
                        ...
                        var s = i(t);
                        if (s === c) return r && r._pushContext(), u = e.reject(s.e), r && r._popContext(), u;
        ...
        21: [function(t, n, r) {
            ...
            function g(t) {
                return null !== t && "object" === (void 0 === t ? "undefined" : e(t)) && "string" == typeof t.message && "string" == typeof t.name
            }
            function m(t) {
                try {
                    f(t, "isOperational", !0)
